// Catalog of candidate dates from the user's CSV dataset (~every 5 days, 2016–2026).
 ...
 * @returns {string|null}
 */
export function findPrevSignalDate(signalDates, currentDate) {
  // Binary search for largest date < currentDate
  let lo = 0;
